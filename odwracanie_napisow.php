...
function wordBackwords($text){
    $newArray = array();
    $words = explode(" ", $text);    //rozbija na małe stringi. przeciwieństwo

    //$newArray = array_reverse($words);  - gotowa metoda na odwrócenie kolejności
    ...
    $backwordsText = implode(" ", $newArray);   //łączy w długi string. przeciwieństo explode
    //var_dump($newArray);
    //var_dump($backwordsText);
    return $backwordsText;
}
//znaczenie ma nie slow powinno byc
